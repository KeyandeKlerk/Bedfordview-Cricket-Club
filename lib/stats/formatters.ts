...
export const BATTING_COLS = [
  ...
  { key: 'balls_per_boundary', label: 'B/Bdry', title: 'Balls faced per boundary (lower = more attacking)' },
]
...
export const BOWLING_COLS = [
  ...
  { key: 'wd_po',                label: 'Wd/Ov',   title: 'Wides per over' },
  { key: 'nb_po',                label: 'NB/Ov',   title: 'No balls per over' },
  { key: 'bdry_po',              label: 'Bdry/Ov', title: 'Boundaries conceded per over' },
]
