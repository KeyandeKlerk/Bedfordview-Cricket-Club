...
import { OrderBarChart, HorizontalBar, OrderSkeleton } from '@/components/admin/OrderCharts'
          ...
          <div className="charts-row">
            {monthlyRevenue.length > 0 && (
              <div className="chart-card">
                <OrderBarChart data={monthlyRevenue} label="Monthly Revenue (last 12 months)" />
              </div>
            )}
